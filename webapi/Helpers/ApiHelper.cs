...
public static class ApiHelper
{
    ...
    public static ApiResponse InternalServerError(string message = Messages.InternalServerError, object data = null!)
    {
        return Response(message, data ?? Array.Empty<object>(), false, 500);
    }
